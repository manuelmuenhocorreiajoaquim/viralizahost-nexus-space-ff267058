    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-[100] flex flex-col gap-3">
        <button
          ...
          className="group relative h-14 w-14 rounded-full bg-gradient-primary shadow-glow grid place-items-center hover:scale-110 transition"
          aria-label="Suporte VIRALIZA"
        >
          {!chatOpen && (
